...
> = {
  ...
  same: {
    label: "Synonyms",
    ask: "Are they synonyms — two words for the same thing?",
    frame: "{a} is another word for {b}.",
    hint: "two words for the same thing",
    color: "#EF4444",
    families: ["synonym"],
  },
  opposite: {
    label: "Antonyms",
    ask: "Are they antonyms — opposites?",
    frame: "{a} is the opposite of {b}.",
    hint: "they point in opposite directions",
    color: "#F97316",
    families: ["antonym"],
  },
};
